"""
Django settings for anthropos project.
"""
...
DATATYPE_LOCATIONS.append('anthropos.datatypes')
FUNCTION_LOCATIONS.append('anthropos.functions')
SEARCH_COMPONENT_LOCATIONS.append('anthropos.search_components')
...
ROOT_URLCONF = 'anthropos.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'anthropos'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'anthropos.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'anthropos.wsgi.application'
...
try:
    ...
    pass
from anthropos.settings_local import *


# no writing locally
LOGGING['loggers']['arches']['handlers'] = ['console']
